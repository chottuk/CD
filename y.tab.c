...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from binary_digit.y  */
...
const int YY_parser_CLASS::digit=258;
...
case 1:
#line 13 "binary_digit.y"
{ans = yyvsp[0];;
    break;}
case 2:
#line 14 "binary_digit.y"
{ans = yyvsp[-1];;
    break;}
case 3:
#line 15 "binary_digit.y"
{yyval = yyvsp[-1] + yyvsp[0];;
    break;}
case 4:
#line 16 "binary_digit.y"
{yyval = yyvsp[0];;
    break;}
case 5:
#line 17 "binary_digit.y"
{
      if(yyvsp[0] == 1)yyval = 1;
      else yyval = 1;
    ;
    break;}
}
